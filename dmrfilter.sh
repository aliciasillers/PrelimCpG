...
#SBATCH --output=dmrfilter.out # File to which STDOUT will be written
#SBATCH --error=dmrfilter.err # File to which STDERR will be written
...
Rscript --vanilla --verbose dmrfilter.R
