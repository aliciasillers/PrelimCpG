...
#SBATCH --output=filter2.out # File to which STDOUT will be written
#SBATCH --error=filter2.err # File to which STDERR will be written
...
Rscript --vanilla --verbose filter2.R
