...
#SBATCH --output=impute.out # File to which STDOUT will be written
#SBATCH --error=impute.err # File to which STDERR will be written
...
Rscript --vanilla --verbose --max-ppsize=500000 impute.R
